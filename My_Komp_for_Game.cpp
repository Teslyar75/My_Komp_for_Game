/*3) Добавить к коду на слайде 24 презентации по Паттернам проектирования (выслана в Тимс)
возможность создавать игровые компьютеры.*/
#include <iostream>
#include <string>
using namespace std;
...
public:
    ...
    void SetHdd() override
    {
        hdd = "Samsung 970 EVO Plus 1TB NVMe M.2";
    }
    void SetMemory() override
    {
